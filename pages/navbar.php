...
<header>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost/TDQMilk/">TDQMILK</a>
        </div>
        <div class="navbar-collapse collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a class="dropdown-toggle" href="http://localhost/TDQMilk/danhmuc/index.php">Danh mục sản phẩm<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <?php
                        while ($row_danhmuc = mysqli_fetch_array($query_danhmuc)) {
                        ?>
                            <li class="nav-item">
                                <a class="dropdown-item" aria-current="page" href="http://localhost/TDQMilk/danhmuc/index.php?quanly=danhmucsanpham&id=<?php echo $row_danhmuc['id_danhmuc'] ?>"><?php echo $row_danhmuc['ten_danhmuc'] ?></a>
                            </li>
                        <?php
                        }
                        ?>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="http://localhost/TDQMilk/danhmuc/index.php?quanly=giohang">Giỏ hàng</a></li>
                <li><a href="pages/Signup/index.php"><span class="glyphicon glyphicon-user"></span> Đăng kí</a></li>
                <li><a href="pages/Login/index.php"><span class="glyphicon glyphicon-log-in"></span> Đăng nhập</a></li>
            </ul>
